    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
     ...
     p-6 flex flex-col gap-6 rounded-lg shadow-lg' >
        ...
        <h2 className='font-medium text-2xl flex justify-between items-center' >
         ...
         {currState==="Sign Up" && !isDataSubmitted && (<input  onChange={(e)=>setFullName(e.target.value)} value={fullName} className='p-2 border border-gray-500 rounded-md focus:outline-none'
...

           {
            currState==="Sign Up" && isDataSubmitted && (
                ...
                rounded-md focus:outline-none focus:ring-indigo-500' placeholder='Provide a short bio...' required ></textarea>
            )
           }
